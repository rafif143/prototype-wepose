      ...
      <div className="container mx-auto px-4 max-w-[1280px]">
        ...
        <div className="flex items-end justify-between mb-12">
          <div>
            ...
            <motion.p
              ...
              className="font-dm-sans text-base text-gray-600 max-w-2xl"
            >
          ...
          >
            <Link href="/dashboard" className="inline-flex items-center gap-2 text-orange hover:text-orange-dark font-poppins font-semibold text-[15px] transition-colors">
              Lihat Dashboard
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          >
            ...
            >
              <Link href="/dashboard" className="inline-flex items-center gap-2 bg-orange text-white px-6 py-3 rounded-full font-poppins font-semibold text-[14px] hover:bg-orange-dark transition-all duration-200">
                Lihat Dashboard
                <ArrowRightIcon className="w-4 h-4 stroke-[2.5]" />
              </Link>
            </motion.div>
