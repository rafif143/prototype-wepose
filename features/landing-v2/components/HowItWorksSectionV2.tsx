...
import { UserPlusIcon, DocumentArrowUpIcon, CreditCardIcon, SignalIcon, ArrowRightIcon } from "@heroicons/react/24/outline"
  ...
  return (
    <section id="how-it-works" className="py-20 bg-gray-50 overflow-hidden">
      <div className="container mx-auto px-4 max-w-[1280px]">
        ...
        <div className="flex items-end justify-between mb-16">
          <div>
            <motion.h2 
              ...
              className="font-poppins font-semibold text-[28px] md:text-[36px] text-navy"
            >
          ...
          >
            <Link href="/auth" className="inline-flex items-center gap-2 text-orange hover:text-orange-dark font-poppins font-semibold text-[15px] transition-colors">
              Mulai Sekarang
        ...
        >
          <Link href="/auth" className="inline-flex items-center gap-2 bg-orange text-white px-8 py-3 rounded-full font-poppins font-semibold text-[15px] hover:bg-orange-dark transition-all duration-200">
            Mulai Sekarang
            <ArrowRightIcon className="w-4 h-4 stroke-[2.5]" />
          </Link>
        </motion.div>
